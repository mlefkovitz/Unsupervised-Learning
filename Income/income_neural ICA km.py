...
X_transformed = KMeans(n_clusters=3, random_state=0).fit_transform(X_transformed)
X_testTransformed = kmeans.transform(X_testTransformed)
...
plt.savefig('Neural Network Learning Curve - ICA KM-3.png', bbox_inches='tight')
