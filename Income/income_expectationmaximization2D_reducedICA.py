...
######
# Run em clustering with 27 clusters
######
cluster = GaussianMixture(random_state=0, n_components=27).fit(X_toCluster)
cluster_labels = cluster.predict(X_toCluster)
...
######
# Run em clustering with 91 clusters
######
cluster = GaussianMixture(random_state=0, n_components=91).fit(X_toCluster)
cluster_labels = cluster.predict(X_toCluster)
