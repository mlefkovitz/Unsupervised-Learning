...
cluster = GaussianMixture(random_state=0, n_components=2).fit(X_transformed)
...
plt.savefig('Neural Network Learning Curve - TruncatedSVD EM-2.png', bbox_inches='tight')
