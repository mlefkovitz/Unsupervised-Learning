...
with plt.style.context('seaborn-whitegrid'):
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('EM Clustering Scores - ICA.png', bbox_inches='tight')
...
with plt.style.context('seaborn-whitegrid'):
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('EM Clustering LL - ICA.png', bbox_inches='tight')
...
with plt.style.context('seaborn-whitegrid'):
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('EM Clustering Silhouette Scores - ICA.png', bbox_inches='tight')
...
with plt.style.context('seaborn-whitegrid'):
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('EM Clustering BIC - ICA.png', bbox_inches='tight')
...
with plt.style.context('seaborn-whitegrid'):
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('EM Clustering AIC - ICA.png', bbox_inches='tight')
