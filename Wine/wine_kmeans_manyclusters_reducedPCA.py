...
with plt.style.context('seaborn-whitegrid'):
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('k-means Clustering Scores - PCA.png', bbox_inches='tight')
...
with plt.style.context('seaborn-whitegrid'):
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('k-means Clustering Silhouette Scores - PCA.png', bbox_inches='tight')
...
with plt.style.context('seaborn-whitegrid'):
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('k-means Clustering BIC - PCA.png', bbox_inches='tight')
