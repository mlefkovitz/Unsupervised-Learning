...
######
# Run em clustering with 12 clusters
######
cluster = GaussianMixture(random_state=0, n_components=12).fit(X_toCluster)
cluster_labels = cluster.predict(X_toCluster)
...
######
# Run em clustering with 97 clusters
######
cluster = GaussianMixture(random_state=0, n_components=97).fit(X_toCluster)
cluster_labels = cluster.predict(X_toCluster)
